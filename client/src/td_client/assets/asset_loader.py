...
class AssetLoader:
    ...
    def scale_surface(
        ...
        scale_to_size: tuple[int, int] | None = None,
    ) -> pygame.Surface:
        ...
        *,
        ...
        if path_str in self._cache:
            ...
            if not scale_factor and not scale_to_size:
                return base_image
            return self.scale_surface(
                base_image, scale_factor=scale_factor, scale_to_size=scale_to_size
            )
        ...
        return self.scale_surface(
            image, scale_factor=scale_factor, scale_to_size=scale_to_size
        )
    ...
    def load_spritesheet(
        ...
        for i in range(frame_count):
            ...
            frame = self.scale_surface(
                frame, scale_factor=scale_factor, scale_to_size=scale_to_size
            )
