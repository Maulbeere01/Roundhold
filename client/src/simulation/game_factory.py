...
from td_client.assets import TemplateManager
from td_client.debug import DebugRenderer
from td_client.map import TileMap, get_visual_map_from_layout
...
class GameFactory:
    """
    Constructs and initializes GameSimulation instances.

    Handles the step-by-step injection of dependencies, map generation,
    and state initialization to ensure a fully configured simulation context.
    """
    ...
    def _initialize_ui(game: GameSimulation) -> None:
        """Initialize UI state and elements."""
        # Player state
